...
<head>
    ...
    <title>Farm DZ</title>
    <link rel="stylesheet" href="../../khadar/home/index.css">
</head>
                    ...
                    <div class="messages">
                        <?php if (empty($messages1)) { ?>
                            ...
                            foreach ($messages1 as $message1) { ?>
                                <div class="msg1" style=<?php if ($message1['envoyer'] == 1) {
                                                            echo 'display:none;';
                                                        } ?>>
                                    <p class="envoyer"><?= $message1['envoyer'] ?></p>
                                </div>
                                <div class="msg2" style=<?php if ($message1['recevoire'] == 1) {
                                                            echo 'display:none;';
                                                        } ?>>
                                    <p class="recevoire"><?= $message1['recevoire'] ?></p>
                                </div><br>
                            <?php }
                            ?>
                        <?php } ?>
