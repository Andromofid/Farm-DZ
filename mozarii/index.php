...
if (isset($_POST['sb'])) {
    ...
    if (empty($tel) || empty($pass)) {
        ...
        $sql = $db->prepare("SELECT * FROM user where tel=? AND pass=? and genre='M'");
...
<body>
    ...
    <form action="#" method="post" class="form">
        ...
        <img src="../img/ic_phone_iphone_grey.png" alt="phon" srcset=""><br>
        ...
        <button type="submit" id="sb" name="sb">تسجيل الدخول</button><br>
